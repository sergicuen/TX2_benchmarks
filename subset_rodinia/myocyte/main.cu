...
#ifdef TIMING
	struct timeval RedTransfer1_start, RedTransfer1_end;
	struct timeval RedTransfer2_start, RedTransfer2_end;
...
#ifdef TIMING
	long int Transfer1, Transfer2;
	Transfer1 = get_time(Transfer1_start, Transfer1_end);
	Transfer2 = get_time(Transfer2_start, Transfer2_end);

	long int TotalTransferTime = Transfer1 + Transfer2;
